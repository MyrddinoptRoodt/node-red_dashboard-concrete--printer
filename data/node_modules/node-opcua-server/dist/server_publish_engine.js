...
class ServerSidePublishEngine extends events_1.EventEmitter {
    ...
    on_close_subscription(subscription) {
        ...
        if (subscription.hasPendingNotifications) {
            doDebug && debugLog("ServerSidePublishEngine#on_close_subscription storing subscription", subscription.id, " to _closed_subscriptions because it has pending notification");
