...
import { DataTypeFactory, IStructuredTypeSchema, StructuredTypeSchema } from "node-opcua-factory";
...
export declare function createDynamicObjectConstructor(schema: IStructuredTypeSchema, dataTypeFactory: DataTypeFactory): AnyConstructorFunc;
export {};
