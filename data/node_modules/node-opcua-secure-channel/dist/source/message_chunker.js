    ...
    chunkSecureMessage(msgType, options, message, messageChunkCallback) {
        ...
        chunkManager
            ...
            if (doTraceChunk) {
                ...
                warningLog((0, node_opcua_utils_1.timestamp)(), "   <$$ ", msgType, "nbChunk = " + nbChunks.toString().padStart(3), "totalLength = " + totalSize.toString().padStart(8), "l=", binSize.toString().padStart(6));
            }
