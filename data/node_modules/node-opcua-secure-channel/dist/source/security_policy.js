...
function RSAPKCS1V15_Decrypt(buffer, privateKey) {
    const blockSize = (0, node_opcua_crypto_1.rsa_length)(privateKey);
...
function RSAPKCS1V15SHA1_Sign(buffer, privateKey) {
    ...
    const params = {
        algorithm: "RSA-SHA1",
        privateKey,
        signatureLength: (0, node_opcua_crypto_1.rsa_length)(privateKey)
    };
...
function RSAPKCS1V15_Encrypt(buffer, publicKey) {
    const keyLength = (0, node_opcua_crypto_1.rsa_length)(publicKey);
