...
class SecureMessageChunkManager extends events_1.EventEmitter {
    constructor(msgType, options, securityHeader, sequenceNumberGenerator) {
        ...
        (0, node_opcua_assert_1.assert)(this.securityHeader !== null && typeof this.securityHeader === "object");
        ...
        (0, node_opcua_assert_1.assert)(isFinite(options.channelId));
    ...
    write_header(finalC, buffer, length) {
        ...
        (0, node_opcua_assert_1.assert)(stream.length === this.headerSize);
    }
