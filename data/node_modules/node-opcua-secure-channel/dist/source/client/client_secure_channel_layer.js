...
const node_opcua_transport_3 = require("node-opcua-transport");
...
class ClientSecureChannelLayer extends events_1.EventEmitter {
    ...
    _install_message_builder() {
        ...
        if (node_opcua_transport_3.doTraceChunk) {
            console.log(chalk.cyan((0, node_opcua_utils_1.timestamp)()), "   MESSGAE BUILDER LIMITS", "maxMessageSize = ", this.messageBuilder.maxMessageSize, "maxChunkCount = ", this.messageBuilder.maxChunkCount, "maxChunkSize = ", this.messageBuilder.maxChunkSize, "(", this.messageBuilder.maxChunkSize * this.messageBuilder.maxChunkCount, ")");
        }
        this.messageBuilder
    ...
    create(endpointUrl, callback) {
        ...
        const transport = new node_opcua_transport_1.ClientTCP_transport(this.transportSettings);
    ...
    _on_transport_closed(err) {
        ...
        this.emit("close", err);
        //
        this._bytesRead += ((_a = this._transport) === null || _a === void 0 ? void 0 : _a.bytesRead) || 0;
        this._bytesWritten += ((_b = this._transport) === null || _b === void 0 ? void 0 : _b.bytesWritten) || 0;
        (_c = this._transport) === null || _c === void 0 ? void 0 : _c.dispose();
        this._transport = undefined;
    ...
    _renew_security_token() {
        ...
        this._open_secure_channel_request(isInitial, (err) => {
            ...
            if (!err) {
                ...
                this._closeWithError(new Error("Restarting because Request has timed out during OpenSecureChannel"), node_opcua_transport_2.StatusCodes2.BadRequestTimeout);
            }
        });
    }
    ...
    _get_security_options_for_OPN() {
        ...
        const options = {};
        options.signatureLength = (0, node_opcua_crypto_1.rsa_length)(senderPrivateKey);
        ...
        const keyLength = (0, node_opcua_crypto_1.rsa_length)(this.receiverPublicKey);
