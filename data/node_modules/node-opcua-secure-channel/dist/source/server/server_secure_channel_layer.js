...
class ServerSecureChannelLayer extends events_1.EventEmitter {
    ...
    dispose() {
        ...
        (0, node_opcua_assert_1.assert)(this.messageBuilder, "dispose already called ?");
        this.parent = null;
    ...
    send_response(msgType, response, message, callback) {
        ...
        (0, node_opcua_assert_1.assert)(requestId !== 0);
        if (this.aborted) {
        ...
        // istanbul ignore next
        if (doDebug) {
            (0, node_opcua_assert_1.assert)(response.schema);
    ...
    _on_initial_open_secure_channel_request(callback, request, msgType, requestId, channelId) {
        ...
        if (!(this.messageBuilder && this.messageBuilder.sequenceHeader && this.messageBuilder.securityHeader)) {
            return this._on_OpenSecureChannelRequestError(node_opcua_status_code_1.StatusCodes.BadCommunicationError, "internal error", message, callback);
        }
    ...
    _process_certificates(message, callback) {
        ...
        this.checkCertificateCallback(certificate, (err, statusCode) => {
            ...
            if (this.receiverCertificate) {
                // extract public key
                (0, node_opcua_crypto_1.extractPublicKeyFromCertificate)(this.receiverCertificate, (err, key) => {
                    if (!err) {
                        if (key) {
                            this.receiverPublicKey = key;
                            this.receiverPublicKeyLength = (0, node_opcua_crypto_1.rsa_length)(key);
                        }
    ...
    _handle_OpenSecureChannelRequest(serviceResult, message, callback) {
        const request = message.request;
        const requestId = message.requestId;
        (0, node_opcua_assert_1.assert)(requestId !== 0 && requestId > 0);
        ...
        (0, node_opcua_assert_1.assert)(this.securityHeader);
