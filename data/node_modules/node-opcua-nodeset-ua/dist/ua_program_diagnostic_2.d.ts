 ...
 * |isAbstract      |false                                             |
 */
export interface UAProgramDiagnostic2_Base<T extends DTProgramDiagnostic2> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
...
export interface UAProgramDiagnostic2<T extends DTProgramDiagnostic2> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UAProgramDiagnostic2_Base<T> {
}
