 ...
 * |isAbstract      |false                                             |
 */
export interface UATransitionVariable_Base<T extends LocalizedText> extends UABaseDataVariable_Base<T, /*e*/ DataType.LocalizedText> {
...
export interface UATransitionVariable<T extends LocalizedText> extends UABaseDataVariable<T, /*n*/ DataType.LocalizedText>, UATransitionVariable_Base<T> {
}
