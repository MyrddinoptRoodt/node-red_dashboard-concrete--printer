 ...
 * |isAbstract      |false                                             |
 */
export interface UASessionDiagnosticsVariable_Base<T extends DTSessionDiagnostics> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
...
export interface UASessionDiagnosticsVariable<T extends DTSessionDiagnostics> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UASessionDiagnosticsVariable_Base<T> {
}
