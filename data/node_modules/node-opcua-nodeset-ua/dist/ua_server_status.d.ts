 ...
 * |isAbstract      |false                                             |
 */
export interface UAServerStatus_Base<T extends DTServerStatus> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
...
export interface UAServerStatus<T extends DTServerStatus> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UAServerStatus_Base<T> {
}
