...
export interface UAProgramStateMachine_currentState<T extends LocalizedText> extends Omit<UAStateVariable<T>, "id" | "number"> {
    id: UAProperty<NodeId, /*z*/ DataType.NodeId>;
    number: UAProperty<UInt32, /*z*/ DataType.UInt32>;
}
export interface UAProgramStateMachine_lastTransition<T extends LocalizedText> extends Omit<UATransitionVariable<T>, "id" | "number" | "transitionTime"> {
    id: UAProperty<NodeId, /*z*/ DataType.NodeId>;
    number: UAProperty<UInt32, /*z*/ DataType.UInt32>;
