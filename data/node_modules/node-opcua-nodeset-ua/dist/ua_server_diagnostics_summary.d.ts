 ...
 * |isAbstract      |false                                             |
 */
export interface UAServerDiagnosticsSummary_Base<T extends DTServerDiagnosticsSummary> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
...
export interface UAServerDiagnosticsSummary<T extends DTServerDiagnosticsSummary> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UAServerDiagnosticsSummary_Base<T> {
}
