...
export interface UAPubSubDiagnosticsDataSetWriter_counters extends UAPubSubDiagnostics_counters {
    failedDataSetMessages: UAPubSubDiagnosticsCounter<UInt32>;
}
export interface UAPubSubDiagnosticsDataSetWriter_liveValues extends UAObject {
