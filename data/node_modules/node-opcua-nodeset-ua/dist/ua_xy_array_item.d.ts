 ...
 * |isAbstract      |false                                             |
 */
export interface UAXYArrayItem_Base<T extends DTXV[]> extends UAArrayItem_Base<T, /*e*/ DataType.ExtensionObject> {
    xAxisDefinition: UAProperty<DTAxisInformation, /*z*/ DataType.ExtensionObject>;
}
export interface UAXYArrayItem<T extends DTXV[]> extends UAArrayItem<T, /*n*/ DataType.ExtensionObject>, UAXYArrayItem_Base<T> {
}
