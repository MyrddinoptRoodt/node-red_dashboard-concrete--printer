 ...
 * |isAbstract      |false                                             |
 */
export interface UAProgramDiagnostic_Base<T extends DTProgramDiagnostic> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
...
export interface UAProgramDiagnostic<T extends DTProgramDiagnostic> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UAProgramDiagnostic_Base<T> {
}
