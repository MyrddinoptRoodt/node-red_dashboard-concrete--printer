...
export interface UAMultiStateDictionaryEntryDiscreteBase<T, DT extends DataType> extends UAMultiStateValueDiscrete<T, /*m*/ DT>, UAMultiStateDictionaryEntryDiscreteBase_Base<T, DT> {
}
