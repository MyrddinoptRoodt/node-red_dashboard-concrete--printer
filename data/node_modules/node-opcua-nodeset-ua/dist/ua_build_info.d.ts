 ...
 * |isAbstract      |false                                             |
 */
export interface UABuildInfo_Base<T extends DTBuildInfo> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
...
export interface UABuildInfo<T extends DTBuildInfo> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UABuildInfo_Base<T> {
}
