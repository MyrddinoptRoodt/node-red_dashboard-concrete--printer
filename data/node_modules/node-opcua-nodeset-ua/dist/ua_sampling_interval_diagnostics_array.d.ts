 ...
 * |isAbstract      |false                                             |
 */
export interface UASamplingIntervalDiagnosticsArray_Base<T extends DTSamplingIntervalDiagnostics[]> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
    samplingIntervalDiagnostics: UASamplingIntervalDiagnostics<DTSamplingIntervalDiagnostics>;
}
export interface UASamplingIntervalDiagnosticsArray<T extends DTSamplingIntervalDiagnostics[]> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UASamplingIntervalDiagnosticsArray_Base<T> {
}
