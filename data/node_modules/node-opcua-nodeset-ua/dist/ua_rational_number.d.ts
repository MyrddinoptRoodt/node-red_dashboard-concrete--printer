 ...
 * |isAbstract      |false                                             |
 */
export interface UARationalNumber_Base<T extends DTRationalNumber> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
    numerator: UABaseDataVariable<Int32, /*z*/ DataType.Int32>;
    denominator: UABaseDataVariable<UInt32, /*z*/ DataType.UInt32>;
}
export interface UARationalNumber<T extends DTRationalNumber> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UARationalNumber_Base<T> {
}
