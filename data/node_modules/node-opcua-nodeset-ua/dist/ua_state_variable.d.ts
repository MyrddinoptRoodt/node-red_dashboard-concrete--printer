 ...
 * |isAbstract      |false                                             |
 */
export interface UAStateVariable_Base<T extends LocalizedText> extends UABaseDataVariable_Base<T, /*e*/ DataType.LocalizedText> {
...
export interface UAStateVariable<T extends LocalizedText> extends UABaseDataVariable<T, /*n*/ DataType.LocalizedText>, UAStateVariable_Base<T> {
}
