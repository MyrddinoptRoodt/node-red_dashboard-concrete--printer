 ...
 * |isAbstract      |false                                             |
 */
export interface UASessionSecurityDiagnosticsArray_Base<T extends DTSessionSecurityDiagnostics[]> extends UABaseDataVariable_Base<T, /*e*/ DataType.ExtensionObject> {
    sessionSecurityDiagnostics: UASessionSecurityDiagnostics<DTSessionSecurityDiagnostics>;
}
export interface UASessionSecurityDiagnosticsArray<T extends DTSessionSecurityDiagnostics[]> extends UABaseDataVariable<T, /*n*/ DataType.ExtensionObject>, UASessionSecurityDiagnosticsArray_Base<T> {
}
