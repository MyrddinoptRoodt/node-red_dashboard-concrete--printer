...
exports.nodesets = exports.constructNodesetFilename = void 0;
const fs = require("fs");
...
function makeDeprecated(id, newName) {
    Object.defineProperty(exports.nodesets, id, {
        get: () => {
            console.log(`nodeset.${id} is deprecated , please use nodeset.${newName} instead`);
            return exports.nodesets[newName];
        }
    });
}
