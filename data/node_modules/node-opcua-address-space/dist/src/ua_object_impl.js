...
class UAObjectImpl extends base_node_impl_1.BaseNodeImpl {
    ...
    clone(options, optionalFilter, extraInfo) {
        options = options || {};
        options = Object.assign(Object.assign({}, options), { eventNotifier: this.eventNotifier, symbolicName: this.symbolicName || undefined });
        const cloneObject = base_node_private_1._clone.call(this, UAObjectImpl, options, optionalFilter || node_opcua_address_space_base_1.defaultCloneFilter, extraInfo || node_opcua_address_space_base_1.defaultCloneExtraInfo);
    ...
    raiseEvent(eventType, data) {
        ...
        (0, node_opcua_assert_1.assert)(eventTypeNode.isSupertypeOf(baseEventType));
