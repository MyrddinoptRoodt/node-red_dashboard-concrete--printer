...
export declare function _setExtensionObject(self: UAVariableImpl, ext: ExtensionObject): void;
export declare function setExtensionObjectValue(node: UAVariableImpl, partialObject: any): void;
export declare function _installExtensionObjectBindingOnProperties(variableNode: UAVariableImpl, options: BindExtensionObjectOptions): void;
export declare function _bindExtensionObject(self: UAVariableImpl, optionalExtensionObject?: ExtensionObject, options?: BindExtensionObjectOptions): any;
