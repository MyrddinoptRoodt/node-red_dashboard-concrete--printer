...
class EventData {
    ...
    resolveSelectClause(selectClause) {
        (0, node_opcua_assert_1.assert)(selectClause instanceof node_opcua_types_1.SimpleAttributeOperand);
        ...
        if (selectClause.browsePath.length === 0 && selectClause.attributeId === node_opcua_data_model_1.AttributeIds.NodeId) {
            (0, node_opcua_assert_1.assert)(!"Cannot use resolveSelectClause on this selectClause as it has no browsePath");
        }
        // navigate to the innerNode specified by the browsePath [ QualifiedName]
        const browsePath = (0, node_opcua_service_translate_browse_path_1.constructBrowsePathFromQualifiedName)(this.$eventDataSource, selectClause.browsePath);
