                ...
                try {
                  ...
                  */
                  ...
                  if (dataValue.statusCode && dataValue.statusCode != opcua.StatusCodes.Good) {
                    verbose_warn("StatusCode: 1) " + dataValue.statusCode.toString(16));
                  }
              ...
              if (dataValue) {
                try {
                  ...
                  */
                  ...
                  if (dataValue.statusCode && dataValue.statusCode != opcua.StatusCodes.Good) {
                    verbose_warn("StatusCode: 2) " + dataValue.statusCode.toString(16));
                  }
...
*/
    ...
    async function subscribe_monitoredItem(subscription, msg) {
      ...
      if (msg.topic === "multiple") {
        ...
        console.log("MONITOR ITEMS: " + JSON.stringify(monitorItems));
        ...
        group.on("changed", (monitoredItem, dataValue, index) => {
          ...
          // verbose_log("Group change on item, index: " + index + " item: " + monitoredItem.toString() + " value: " + dataValue.toString());
      ...
      if (!monitoredItem) {
        ...
        monitoredItem.on("changed", function (dataValue) {
          ...
          // verbose_log(dataValue.toString());
          if (dataValue.statusCode !== opcua.StatusCodes.Good) {
            verbose_warn("StatusCode: 3) " + dataValue.statusCode.toString(16));
          }
    ...
    async function monitor_monitoredItem(subscription, msg) {
      ...
      if (!monitoredItem) {
        ...
        group.on("changed", (monitoredItem, dataValue, index) => {
          ...
          verbose_log(dataValue.toString());
          if (dataValue.statusCode !== opcua.StatusCodes.Good) {
            verbose_warn("StatusCode: 4) " + dataValue.statusCode.toString(16));
          }
          var msgToSend = {};
          msgToSend.statusCode = dataValue.statusCode;
          msgToSend.topic = msg.topic;
