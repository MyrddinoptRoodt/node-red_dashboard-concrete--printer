...
const line_file_1 = require("./utils/line_file");
const write_func_1 = require("./utils/write_func");
const doDebug = (0, node_opcua_debug_1.checkDebugFlag)(__filename);
const debugLog = (0, node_opcua_debug_1.make_debugLog)(__filename);
const f = new line_file_1.LineFile1();
...
function writeEnumeratedType(enumerationSchema) {
    ...
    write(`};`);
    write(`function decode${enumerationSchema.name}(stream: BinaryStream, _value?: ${enumerationSchema.name}): ${enumerationSchema.name} {`);
    if (!isFlaggable) {
        if (enumerationSchema.lengthInBits === 16) {
            write(`    let value =  stream.readUInt16() as ${enumerationSchema.name};`);
        }
        else {
            (0, node_opcua_assert_1.assert)(enumerationSchema.lengthInBits === 32);
...
function writeStructuredTypeWithSchema(structuredType) {
    ...
    write(`    ]`);
    write(`});`);
    (0, factory_code_generator_1.writeStructuredType)(write, structuredType);
}
